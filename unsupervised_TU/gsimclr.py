...
if __name__ == '__main__':
    ...
    dataset = TUDataset(path, name=DS, aug=args.aug, dnodes_degree=args.dnodes_degree,
                        pedges_degree=args.pedges_degree, subgraph_degree=args.subgraph_degree,
                        mask_nodes_degree=args.mask_nodes_degree).shuffle()
    dataset_eval = TUDataset(path, name=DS, aug='none').shuffle()
    print(len(dataset))
    print(dataset.get_num_feature())
    print(args.DS, args.aug)
    try:
    ...
    with open('logs/log_' + args.DS + '_' + args.aug + '.txt', 'a+') as f:
